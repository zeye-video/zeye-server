...
async function createExpressApp()
{
	...
	expressApp = express();
	var corsOptions = {
		origin: [process.env.AUTH_ENDPOINT_ORIGIN],
		credentials: true,
	...
	expressApp.get(
		'/getUsage', (req, res) =>
		{
			...
			rooms.forEach(function(room) {
				peers += room._protooRoom._peers.size

				activeRooms = room._protooRoom._peers.size > 0 ? ++activeRooms : activeRooms
			})
